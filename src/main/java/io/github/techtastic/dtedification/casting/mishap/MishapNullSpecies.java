...
public class MishapNullSpecies extends Mishap {
    Species species = Species.NULL_SPECIES;

    public MishapNullSpecies(Species species) {
    ...
    protected Component errorMessage(@NotNull CastingEnvironment castingEnvironment, @NotNull Mishap.Context context) {
        return HexUtils.asTranslatedComponent("dtedification.mishap.bad_species", this.species.getLocalizedName());
    }
}
